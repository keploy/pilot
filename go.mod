...
replace go.keploy.io/server => /home/gouravkumar.linux/gk_workspace/keploy

require (
	go.keploy.io/server v0.9.1-20240115000000-f0a459b625efe95704e629daf8589c87d9d9283f
